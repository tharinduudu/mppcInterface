...
int main(int argc, char** argv) {
    ...
    while (1) {
        ...
        printf("%d,%d,%d,%d,%d,%s",counters[4], counters[3], counters[0], counters[1], counters[2], asctime(timeinfo));
        output << counters[4] << ", "<< counters[3] << ", " << counters[0] << ", " << counters[1] << ", " << counters[2] << ", " << asctime(timeinfo);
